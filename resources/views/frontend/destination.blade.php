               ...
               <div class="col-lg-9">
                     ...
                     <div class="leaflet-map">
                          ...
                          <div class="row">
                              ...
                              <div class="row">
                              <div class="col-sm-12"><input type="checkbox" id="sunToggle" class="js-switch"><span class="p5" >{{__('destination.sunsetting')}}</span></div>
                              </div>
                          ...
                          <div class="row pt-1 pb-1 pr-1 pl-1 bgregbox min100">  
                                <div id="container_video" width="50%" ></div>
                          </div> 
