...
<section id="ts-features" class="ts-features">
    <div class="container">
        ...
        <div class="row">       
          ...
          <div class="col-lg-6 center p1"><div id="mapzoom"></div></div>
          <div class="col-lg-6 center p1"><livewire:show-img-region /></div>
        </div>
        <div class="row bgregbox min100">  
          <div class="col-lg-6 p1"><livewire:show-map-globale /></div>
          <div class="col-lg-6 p1"><livewire:show-peak-region /></div>
        </div>             
