...
acceptedFiles: ".jpeg,.jpg,.png,.gif,.webp", // Extensions autorisées
                    ...
                    <ul class="image-gallery">
                        ...
                        <<li>
                            ...
                            <div class="overlay">
                                ...
                                <a href="{{ route('delimagespot', $photo->id) }}" class="delete-photo" onclick="return confirm('Are you sure you want to delete this image?');">
