...
Ensuite, le magma se fraye un chemin par des fractures pour créer des eruptions volcaniques.</p><p>Il a une durée de vie de plusieurs millions d'années et on peut le considérer comme fixe à l'échelle du globe.</p></div>
    ...
    <p>insi, un volcan situé au-dessus d'un point chaud n'est pas éternellement en éruption. Lorsque la plaque tectonique se déplace sur le point chaud (stationnaire), le volcan est déporté et de nouvelles éruptions se forment à sa place. Il en résulte des chaînes de volcans, comme les îles hawaïennes, Iles Marquises ou autres.</p>

</div>

Pourquoi sont ils important pour la construction des terres immergées ?





Photo Carte Hot spots

 Si au cours des siècles on constate qu’un point chaud s’est déplacé par rapport à un point donné sur terre, c’est en fait  en raison du déplacement de la croute terrestre qui se déplace avec une plaque tectonique.
A
...
La théorie est encore discuté par les scientifiques et le concept est assez récent. En fonction des écrits que vous pourrez consulter certaines variantes sur la profondeur d’origine  du phénomène.

La théorie dominante, élaborée par le géophysicien canadien J. Tuzo Wilson en 1963, stipule que les volcans de point chaud sont créés par des zones exceptionnellement chaudes fixées en profondeur sous le manteau terrestre.

D’autres scientifiques pense que leur origine est beaucoup plus profondes.
