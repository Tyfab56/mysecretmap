              ...
              <nav class="navbar navbar-expand-lg navbar-dark p-0">
                ...
                <div id="navbar-collapse" class="collapse navbar-collapse">
                  ...
                  <ul class="nav navbar-nav mr-auto">
                    ...
                    <li class="nav-item dropdown">
                      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><img src="{{ asset('frontend/assets/images/'.App::getLocale().'flag.jpg') }}" class="mr5 mt-5" style="width: 20px; height: 14px;">{{ Config::get('languages')[App::getLocale()] }} <i class="fa fa-angle-down"></i></a>
                      <ul class="dropdown-menu" role="menu">
